...
time.sleep(0.1)
print("""\033[96m╔═════════════════════════════════════════════╗
\033[96m║ \33[33;1m  *Author   ║MrxMilzu.                  \033[96m    ║
\033[96m║ \33[33;1m  *FACEBOOK ║https://facebook.com/Milzu Tc\033[96m  ║
\033[96m║ \33[33;1m  *INSTAGRAM║ -                           \033[96m  ║
\033[96m╚═════════════════════════════════════════════╝""")
...
\033[90m  ██  ██
\033[94m ╔═════════════════════════════════════════════════
\033[94m ║\033[92m•\033[91m_\033[93mMBF\033[91m_
\033[94m ║\033[92m•\033[93mSubscribe\033[91m:\033[92mMILZU-TC TUTORIAL77
\033[94m ║═════════════════════════════════════════════════
\033[94m ║\033[92m•\033[93mTahun Pembuatan server\033[91m:\033[92m2021
\033[94m ║═════════════════════════════════════════════════
\033[94m ║\033[92m[\033[91m+\033[92m]\033[92mxAuthor  \033[91m: \033[92mMilzu TC
\033[94m ║\033[93m[\033[92m+\033[93m]\033[93mInstagram\033[91m: \033[93m-
...
def mbfv2():
    time.sleep(0.1)
    print(" \x1b[92m║═╔═══════════════════════════════════════════════╗")
    print(" \033[92m║═╚═>[\033[96m?\033[90m] \033[92m01\033[97m.\033[96mMÂŠÛĶ                               \033[92m~═║")
    print(" \033[92m║═╔═════════════════════════════════════════════~═║")
    print(" \033[92m║═╚═>[\033[96m?\033[90m] \033[92m02\033[97m.\033[96mČÂŘÂ MÊŇĎÂPÂŤĶÂŇ ČÔĶÎÊ              \033[92m~═║")
    print(" \033[92m║═╔═════════════════════════════════════════════~═║")
    print(" \033[92m║═╚═>[\033[96m?\033[90m] \033[92m03\033[97m.\033[96mMÂŠÛĶ ĞŘÛP FB《COMUNITY》OF THE HACKER\033[92m║")
    print(" \033[92m║═╔═════════════════════════════════════════════~═║")
    print(" \033[92m║═╚═>[\033[96m?\033[90m] \033[92m04\033[97m.\033[96mMÂŠÛĶ ĞŘÛP WHÂŤŠÂPP                 \033[92m~═║")
    print(" \033[92m║═╔═════════════════════════════════════════════~═║")
    print(" \033[92m║═╚═>[\033[96m?\033[90m] \033[92m05\033[97m.\033[96mÛPĞŘÂĎÊ ŠÊŘVÊŘ                      \033[92m~═║")
    print(" \033[92m║═╔═════════════════════════════════════════════~═║")
    print(" \033[92m║═╚═>[\033[93m!\033[90m] \033[91m00\033[97m.\033[96mĶÊŁÛÂŘ                              \033[92m~═║")
    print(" \x1b[92m╚═════════════════════════════════════════════════╝")
    time.sleep(0.1)
    ...
    if uwu == "1" or uwu =="01":
         ...
         if __name__ == '__main__':
               try:
                   ...
                   aink(" \033[92m║═╔═════════════════════════════════════════════~═║")
                   aink(" \033[92m║═╚═>[\033[93m!\033[90m] \033[91m06\033[97m.\033[96mLIHAT HASIL CRECK                   \033[92m~═║")
                   aink(" \x1b[92m║═╔═════════════════════════════════════════════~═║")
                   aink(" \033[92m║═╚═>[\033[96m?\033[90m] \033[92m07\033[97m.\033[96mHAPUS BISKUIT YANG LEZAT            \033[92m~═║")
                   aink(" \033[92m║═╔═════════════════════════════════════════════~═║")
                   aink(" \033[92m║═╚═>[\033[96m?\033[90m] \033[92m00\033[97m.\033[96mKELUAR                              \033[92m~═║")
                   aink(" \033[92m╚═════════════════════════════════════════════════╝")
                   print("\033[93m╭╼[Mrx.Milzu]─[05-09-2021]")
                   print ("\033[93m~")
                   uwu=input("\033[93m╰╼▪>   \033[96m")

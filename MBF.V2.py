...
\033[90m █▄█████▄█          ╔═╦═╗ ╔╗  ╔═╗
\033[90m █ \033[97m▼▼▼▼▼ - _ --_--  ║ ║ ║ ╠╩╗ ╠╣
\033[90m █ \033[97m _-_-- -_ --__ \033[96mC\033[90m.\033[91m╝   ╚ ╚═╝ ╚   *V.2
\033[90m █ \033[97m▲▲▲▲▲ --  - _ - 
...
\033[90m  ██  ██      🎭\033[90mPengarang/Edit  : \033[92mFxki-\033[96mCyber
 ...
 \033[90m║═════════════════════════════════════════════════
 \033[90m║\033[97m•\033[97mTahun Pembuatan tools\033[91m:\033[92m2021
 \033[90m║═════════════════════════════════════════════════
 \033[90m║
 \033[90m║═════════════════════════════════════════════════
 \033[90m║\033[97m[\033[90m+\033[97m]\033[97mxAuthor  \033[97m: \033[91mM\033[97mi\033[91ml\033[97mz\033[91mu T\033[97mC
 \033[90m║\033[97m[\033[90m+\033[97m]\033[97mInstagram\033[97m: \033[91m-
...
def mbfv2():
    time.sleep(0.1)
    aink(" \x1b[90m║═╔═══════════════════════════════════════════════╗")
    aink(" \033[90m║═╚═>[\033[91m?\033[90m] \033[97m01.\033[97mMÂŠÛĶ                               \033[91m~═\033[90m║")
    aink(" \033[90m║═╔═════════════════════════════════════════════~═\033[90m║")
    aink(" \033[90m║═╚═>[\033[91m?\033[90m] \033[91m02.\033[97mČÂŘÂ MÊŇĎÂPÂŤĶÂŇ ČÔĶÎÊ              \033[91m~═\033[90m║")
    aink(" \033[90m║═╔═════════════════════════════════════════════~═\033[90m║")
    aink(" \033[90m║═╚═>[\033[91m?\033[90m] \033[97m03.\033[97mMÂŠÛĶ ĞŘÛP FB《COMUNITY》OF THE HACKER\033[90m║")
    aink(" \033[90m║═╔═════════════════════════════════════════════~═\033[90m║")
    aink(" \033[90m║═╚═>[\033[91m?\033[90m] \033[91m04.\033[97mMÂŠÛĶ ĞŘÛP WHÂŤŠÂPP                 \033[91m~═\033[90m║")
    aink(" \033[90m║═╔═════════════════════════════════════════════~═\033[90m║")
    aink(" \033[90m║═╚═>[\033[91m?\033[90m] \033[97m05.\033[97mÛPĞŘÂĎÊ ŠÊŘVÊŘ                      \033[91m~═\033[90m║")
    aink(" \033[90m║═╔═════════════════════════════════════════════~═\033[90m║")
    aink(" \033[90m║═╚═>[\033[91m!\033[90m] \033[97m00\033[97m.\033[91mĶÊŁÛÂŘ                              \033[91m~═\033[90m║")
    aink(" \x1b[90m╚═════════════════════════════════════════════════╝")
    time.sleep(0.1)

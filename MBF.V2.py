...
def mbfv2():
    time.sleep(0.1)
    print(" \x1b[92m╔═╔════════════════════════════════════════════════")
    print(" \033[92m║═╚═>[\033[96m?\033[90m] \033[92m01\033[97m.\033[96mMÂŠÛĶ                                  ~═║")
    print(" \033[92m║═╔═════════════════════════════════════════════~═║")
    print(" \033[92m║═╚═>[\033[96m?\033[90m] \033[92m02\033[97m.\033[96mČÂŘÂ MÊŇĎÂPÂŤĶÂŇ ČÔĶÎÊ                 ~═║")
    print(" \033[92m║═╔═════════════════════════════════════════════~═║")
    print(" \033[92m║═╚═>[\033[96m?\033[90m] \033[92m03\033[97m.\033[96mMÂŠÛĶ ĞŘÛP FB《COMUNITY》OF THE HACKER║")
    print(" \033[92m║═╔═════════════════════════════════════════════~═║")
    print(" \033[92m║═╚═>[\033[96m?\033[90m] \033[92m04\033[97m.\033[96mMÂŠÛĶ ĞŘÛP WHÂŤŠÂPP                    ~═║")
    print(" \033[92m║═╔═════════════════════════════════════════════~═║")
    print(" \033[92m║═╚═>[\033[96m?\033[90m] \033[92m05\033[97m.\033[96mÛPĞŘÂĎÊ ŠÊŘVÊŘ                         ~═║")
    print(" \033[92m║═╔═════════════════════════════════════════════~═║")
    print(" \033[92m║═╚═>[\033[93m!\033[90m] \033[91m00\033[97m.\033[96mĶÊŁÛÂŘ                                 ~═║")
    print(" \x1b[92m╚══════════════════════════════════════════════════")
    time.sleep(0.1)
